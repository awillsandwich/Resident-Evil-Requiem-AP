...
class ResidentEvil9(World):
    """
    'I think I want a second opinion.' - Leon S. Kennedy, probably
    """
    game: str = "Resident Evil 9"
    ...
    location_id_to_name = { loc['id']: RE9Location.stack_names(loc['region'], loc['name']) for loc in Data.location_table }
    location_name_to_id = { RE9Location.stack_names(loc['region'], loc['name']): loc['id'] for loc in Data.location_table }
    location_name_to_location = { RE9Location.stack_names(loc['region'], loc['name']): loc for loc in Data.location_table }
